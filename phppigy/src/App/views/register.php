...
>
  ...
  <?php include $this->resolve('partials/_csrf.php'); ?>
    ...
    <label class="block">
      ...
      <select
        name="country"
        class="block w-full mt-1 h-10 px-2 rounded-md border-gray-300 shadow-sm focus:border-emerald-300 focus:ring focus:ring-emerald-200 focus:ring-opacity-50"
      >
    ...
    <button
      type="submit"
      class="block w-full py-2 bg-emerald-600 text-white rounded"
    >
      Submit
    </button>
  </form>
